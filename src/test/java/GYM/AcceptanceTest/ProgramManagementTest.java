...
public class ProgramManagementTest {
    ...
    Program P3,P2 = new Program( "yoga",  "difficultyLevel","focus", 10 ,7);
    ...
    public void the_instructor_update_the_program_details() {
        P2 = new Program( "yoga",  "difficultyLevel","focus", 10 ,7  );
        Updated=I1.UpdateProgram("yoga",  "difficultyLevel","focus", 10 ,7);
    ...
    public void the_instructor_select_an_existing_program_and_click_on_the_delete_button(){
        ...
        fakeDate=LocalDate.of(2025,3,25);
